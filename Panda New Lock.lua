...
local L_8_ = L_7_:NewSection("Pandaluver")
L_8_:NewButton(
    "Silent Aim",
...
local L_12_ = L_11_:NewSection("Pandaluvs")
L_12_:NewButton(
    "Anti-Lock",
    "Key is Z.",
    function()
...
local L_14_ = L_13_:NewSection("Pandaluver")
L_14_:NewKeybind(
    "Keybind Gui Toggle",
    "h",
    Enum.KeyCode.V,
...
local L_19_ = L_17_:NewSection("PandaLuvs")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
